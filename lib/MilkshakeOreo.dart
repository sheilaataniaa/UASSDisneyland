...
class mkoreocart extends StatelessWidget {
  const mkoreocart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '23', //product id dalam database
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/oremkremovebg.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
