...
class jusapelcart extends StatelessWidget {
  const jusapelcart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '27', //product id dalam database
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/jusapel.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
