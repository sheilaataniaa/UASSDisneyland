...
class mkvanilacart extends StatelessWidget {
  const mkvanilacart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '20', //product id dalam database
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/mkvremovebg2.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
