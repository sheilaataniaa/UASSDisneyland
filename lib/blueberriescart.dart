...
class Blueberriescart extends StatelessWidget {
  const Blueberriescart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '31', //product id dalam database
    productName: 'Blueberries Cheese',
    initialPrice: 75000,
    productPrice: 75000,
    quantity: 1,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/blueberries.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
