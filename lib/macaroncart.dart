...
class Macaroncart extends StatelessWidget {
  const Macaroncart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '30', //product id dalam database
    productName: 'Macaron Mix 6 pcs',
    initialPrice: 105000,
    productPrice: 105000,
    quantity: 1,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/macaron.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
