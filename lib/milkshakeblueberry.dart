...
class mkblucart extends StatelessWidget {
  const mkblucart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '21', //product id dalam database
    productName: 'Blueberry Milkshake',
    initialPrice: 55000,
    productPrice: 55000,
    quantity: 1,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/bluberrbg.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
