...
class jusorencart extends StatelessWidget {
  const jusorencart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '24', //product id dalam database
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/juskjeruk.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
