...
class jusmanggacart extends StatelessWidget {
  const jusmanggacart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '29', //product id dalam database
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/jusmangga.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
