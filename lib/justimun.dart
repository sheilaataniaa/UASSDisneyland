...
class justimuncart extends StatelessWidget {
  const justimuncart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '26', //product id dalam database
    productName: 'Cucumber Juice',
    initialPrice: 40000,
    productPrice: 40000,
    quantity: 1,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/jusmentimun.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
