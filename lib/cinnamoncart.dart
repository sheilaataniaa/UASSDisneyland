...
class Cinnamoncart extends StatelessWidget {
  const Cinnamoncart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '12', //product id dalam database
    productName: 'Cinnamon Coffe',
    initialPrice: 60000,
    productPrice: 60000,
    quantity: 1,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/cinnamon.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
