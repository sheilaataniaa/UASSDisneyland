...
class Gantungancart extends StatelessWidget {
  const Gantungancart({Key? key}) : super(key: key);
...
DBHelper? dbHelper = DBHelper();
    ...
    Cart product = Cart(
      id: null,
      productId: '9', //product id dalam database
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/gantungan.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
