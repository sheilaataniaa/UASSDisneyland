...
class Chocbubblecart extends StatelessWidget {
  const Chocbubblecart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '13', //product id dalam database
    productName: 'Chocolate Milk Tea',
    initialPrice: 55000,
    productPrice: 55000,
    quantity: 1,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/chocbubble.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
