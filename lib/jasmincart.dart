...
class Jasmincart extends StatelessWidget {
  const Jasmincart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  Cart product = Cart(
    id: null,
    productId: '18', //product id dalam database
    productName: 'Ice Jasmine Tea',
    initialPrice: 40000,
    productPrice: 40000,
    quantity: 1,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/jasmin.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
