...
class Bajucart extends StatelessWidget {
  const Bajucart({Key? key}) : super(key: key);
...
class _AddToCartState extends State<AddToCart3> {
  ...
  DBHelper? dbHelper = DBHelper();
    ...
    Cart product = Cart(
      id: null,
      productId: '7', //product id dalam database
      productName: 'T-Shirt',
      initialPrice: 175000,
      productPrice: 175000,
      quantity: 1,
        ...
        children: [
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              //  Navigator.pushReplacement(
                //  context,
                  //MaterialPageRoute(builder: (context) => Bajucart()),
                //);
              },
              child: SizedBox(
                width: 407,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/baju.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
